...
<%--  <link rel="stylesheet" href="${bonuspath}/bootstrap-3.3.7-dist/css/bootstrap.css"/> --%>

<link rel="stylesheet"
	href="${bonuspath}/static/plugins/layer/2.1/skin/layer.css" />
	<link rel="stylesheet" type="text/css"  href="${bonuspath}/static/css/bootstrap/bootstrap.min.css" />
<script src="../../../../static/js/jquery/jquery-2.0.3.min.js"
...
<script src="examineviewer.js"></script>
<script src="viewer.js"></script>
</head>

<body tabindex="1" class="loadingInProgress">
	<div id="outerContainer" style="width: 70%; float: left;">
	...
	<!-- outerContainer -->
	<div
		style="width: 20%; height: 95%; background-color: #fff; float: left; margin: 2% 0% 0% 2%; padding: 3%;">
		<div class="" style="font-size: 20px; text-align: center;">
			<strong id="title"></strong>
		</div>
		<ul>
			<li><span>数据来源</span>：<span id="fileSource"></span></li>
			<li><span>上传时间</span>：<span id="uploadTime"></span></li>
			<li><span>发布人</span>：<span id="fileAuthor"></span></li>
			<li><span>发布内容</span>：<span id="publishContent"></span></li>
		</ul>
		<!-- <button style="margin-left: 35px;margin-right: 10px;background-color: #159997;color: white;" class="btn btn-grey" onclick="examinePass(2);">审核通过</button>
		<button style="color: white;" class="btn btn-grey" onclick="examinePass(3);">审核未通过</button> -->
	</div>
