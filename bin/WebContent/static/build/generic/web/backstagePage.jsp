...
<body tabindex="1" class="loadingInProgress">
	...
	<!-- outerContainer -->
	<div
		style="width: 20%; height: 80%; background-color: #fff; float: left; margin: 2% 0% 0% 2%; padding: 3%;">
		...
		<!-- <button style="" onclick="examinePass(2);">审核通过</button>
		<button style="" onclick="examinePass(3);">审核未通过</button> -->
	</div>
