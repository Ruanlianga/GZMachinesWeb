...
function requestSource(){
	$.ajax({
		...
		success:function(data){	
			...
			DEFAULT_URL =bonuspath+ l.fileTransPath;
		},
		error:function(data){}
	});
}
...
function getMess(){
	$.ajax({
		...
		success:function(data){	
			var l=data.obj.list[0];
			//fileTransPath = l.fileUpdatePath
	    	$("#fileSource").html(l.fileSource);
	    	$("#uploadTime").html(l.uploadTime);
	    	$("#fileAuthor").html(l.publisher);
	    	$("#publishContent").html(l.publishContent);
		},
		error:function(data){}
	});
}
