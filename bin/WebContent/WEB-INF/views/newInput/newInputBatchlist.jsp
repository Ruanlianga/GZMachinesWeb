			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							&ensp;&ensp;&ensp;<div class="layui-input-inline">
					       		<input type="text" value="<%=nowTime%>" class="input-large" id="time" name="time" >
					    	</div>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">采购员</th>
								<th style="width:10%" class="center">到货时间</th>
								<th style="width:10%" class="center">接收人</th>
