...
<div class="page-content" >
		<div class="row-fluid">	
					...
					<div class="row">
						<div class="widget-main">	
							<div class="layui-input-inline">
					        	<input type="text" class="input-large" id="outNum" name="outNum" style="display: none;">
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead >
							<tr>
								...
								<th style="width:10%" class="center">批次编号</th>
			...
			<!-- #addorUpdateFrom -->
			<%@include file="repair_machine_details_form.jsp" %>
			<!-- #dialog-confirm -->
			<%@include file="../dialog.jsp" %>	
			</div>
		</div>
	</div>
<script src="${bonuspath}/static/js/lease/repair_machine_details.js?v=1"></script>		
</body>
</html>