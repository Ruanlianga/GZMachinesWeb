					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:6%" class="center">批次编号</th>
								<th style="width:6%" class="center">批次时间</th>
								<th style="width:6%" class="center">审核人</th>
								<th style="width:6%" class="center">检修人</th>
...
<script src="${bonuspath}/static/js/lease/repairInput.js?v=1"></script>		
</body>
</html>