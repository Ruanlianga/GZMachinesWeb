...
<div class="page-content">
		<div class="row-fluid">	
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:6%" class="center">维修单号</th>
								<th style="width:6%" class="center">机具名称</th>
								<th style="width:6%" class="center">规格型号</th>
								<th style="width:3%" class="center">数量</th>
								<th style="width:4%" class="center">单价（元）</th>
								<th style="width:6%" class="center">小计（元）</th>
								<th style="width:6%" class="center">领用工程</th>
								<th style="width:6%" class="center">设备编号</th>
								<th style="width:10%" class="center">报废原因</th>
								<th style="width:4%" class="center">设备状态</th>
			...
			<!-- #addorUpdateFrom -->
			<%@include file="repairInputform.jsp" %>
			<!-- #dialog-confirm -->
			<%@include file="../dialog.jsp" %>	
			</div>
		</div>
	</div>
<script src="${bonuspath}/static/js/lease/scrap.js?v=1"></script>	
</body>
</html>