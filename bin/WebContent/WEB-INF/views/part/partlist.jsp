...
<div class="page-content">
		<div class="row-fluid">	
			<div class="col-xs-12">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;		<input type="text" name="typeName"  id ='typeName'  placeholder="这里输入关键词"   class="input-large">			
		...
		<!-- 					   -->
								 <th style="width:8%" class="center">厂家</th>
			                      <th style="width:8%" class="center">规格型号</th>
			                      <th style="width:8%" class="center">类型</th>
			                      	 <th style="width:8%" class="center">单价</th> 
					               <th style="width:8%" class="center">出厂时间</th>
		                           <th style="width:8%" class="center">备注</th>
							    	<th style="width:6%" class="center">数量</th>
								<th style="width:8%" class="center">是否是消耗品</th>
...
<!-- 								<a href="#" title="批量删除" id="delBatchBtn" class="lrspace3" ><i class='icon-trash color-red bigger-220'></i></a>
 -->							</div>
			...
			<!-- #addorUpdateFrom -->
			<%@include file="partform.jsp" %>
			<!-- #dialog-confirm -->
			<%@include file="../dialog.jsp" %>	
			</div>
		</div>
	</div>
<script src="${bonuspath}/static/js/part/part.js?v=1"></script>		
</body>
</html>