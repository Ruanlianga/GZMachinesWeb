			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="email"  maxlength="32" name="mail" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>	
					<tr class="FormData">
						<td class="CaptionTD">电话号码：</td>
						<td class="DataTD">&nbsp;
						<input type="text"  maxlength="32" name="telphone" class="FormElement ui-widget-content ui-corner-all">
						</td>
					</tr> 
					<tr class="FormData">
						<td class="CaptionTD">岗位：</td>
						<td class="DataTD">&nbsp;
						<select id="postName" name="postName" ></select>
						</td>
					</tr> 
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text"  maxlength="32" name="officeAddress" class="FormElement ui-widget-content ui-corner-all">
						</td>
					</tr>
