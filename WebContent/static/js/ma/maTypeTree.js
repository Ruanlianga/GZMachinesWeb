...
function onTreeClick(event, treeId, treeNode, clickFlag){
	...
	if(treeNode.id.indexOf("zl") != -1 || treeNode.id.indexOf("dl") != -1){
		...
		localStorage.setItem("maTypeId",treeNode.id);
		localStorage.setItem("maTypeName",treeNode.name);
		localStorage.setItem("isCount",treeNode.isCount);
		window.parent.setMaTypeForm();
