...
function exportData(){
	...
	$("#baseForm").attr("action",bonuspath +'/backstage/machinerfid/export');
...
function getbaseList(index) {
	...
	JY.Model.loading();
	JY.Ajax.doRequest("baseForm",bonuspath + '/backstage/machinerfid/findByPage',null,
		function(data) {
			...
			if (results != null && results.length > 0) {
				...
				for (var i = 0; i < results.length; i++) {
					...
					html += "<td style='vertical-align:middle;' class='center'>"+ JY.Object.notEmpty(l.epcCode) + "</td>";
