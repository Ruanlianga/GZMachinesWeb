...
function exportData(){
	...
	$("#baseForm").attr("action",bonuspath +'/backstage/settlementTotal/export');
...
//	var agreementCode= $("#agreementCode").val();
	...
	JY.Ajax
			.doRequest(
					"baseForm",
					bonuspath + '/backstage/settlementTotal/findByPage',
					null,
					function(data) {
						...
						if (results != null && results.length > 0) {
							...
							for (var i = 0; i < results.length; i++) {
								...
								html += "<td style='vertical-align:middle;' class='center'>"
									...
									+ "</td>";
								html += "<td style='vertical-align:middle;' class='center'>"
									+ JY.Object.notEmpty(l.leaseMoney)
									+ "</td>";
								html += "<td style='vertical-align:middle;' class='center'>"
									+ JY.Object.notEmpty(l.loseMoney)
									+ "</td>";
								html += "<td style='vertical-align:middle;' class='center'>"
									+ JY.Object.notEmpty(l.deductionMoney)
									+ "</td>";
								html += "<td style='vertical-align:middle;' class='center'>"
									+ JY.Object.notEmpty(l.totalMoney)
									+ "</td>";
