					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">厂家名称</th>
								<th style="width:10%" class="center">厂家地址</th>
								<th style="width:10%" class="center">法人代表</th>
								<th style="width:10%" class="center">主要联系人</th>
								<th style="width:10%" class="center">联系电话</th>
								<th style="width:10%" class="center">主要经营范围</th>
...
<script src="${bonuspath}/static/js/ma/vender.js?v=1"></script>		
</body>
</html>