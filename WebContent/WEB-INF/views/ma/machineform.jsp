		...
		$.ajax({
			...
			success: function(data) {
				...
				if((machineNewUrl == '' || machineNewUrl == null) && (certificateFilePath == '' || certificateFilePath == null)){
					str += '<div class="left">';
					str+='<div id="machinePic" style="color:red;font-size:18px; height: 49.5%; display: flex; justify-content: center; align-items: center"><span>暂无机具图片</span> <button type="button" class="layui-btn" id="upload">上传图片</button></div>';
					str+='<div style="color:red;font-size:18px; height: 49.5%; border-top: 1px solid #808080; display: flex; justify-content: center; align-items: center">暂无合格证标签图片</div>';
					str += '</div>';
					...
					str += '<div class="left">';
					str+='<div id="machinePic" style="color:red;font-size:18px; height: 49.5%; display: flex; justify-content: center; align-items: center"><span>暂无机具图片</span><button type="button" class="layui-btn" id="upload">上传图片</button></div>';
					str+='<div style="height: 49.5%; border-top: 1px solid #808080; display: flex; justify-content: center; align-items: center"><img class="machinesImg" src=\"' + certificateFilePath + '\" /></div>';
					str += '</div>';
				}
				if((machineNewUrl != '' && machineNewUrl != null) && (certificateFilePath == '' || certificateFilePath == null)){
					str += '<div class="left">';
					str+='<div style="height: 49.5%; display: flex; justify-content: center; align-items: center"><img class="machinesImg" src=\"'+preUrl+ machineNewUrl +'\" /></div>';
					str+='<div style="color:red;font-size:18px; display: flex; justify-content: center; align-items: center height: 49.5%; display: flex; justify-content: center; align-items: center">暂无合格证标签图片</div>';
					str += '</div>';
				}else if((machineNewUrl != '' && machineNewUrl != null) && (certificateFilePath != '' && certificateFilePath != null)){
					var filePath = JY.Object.notEmpty(l.filePath);
					var path = l.filePath.replaceAll(/\\/g,"/");
					...
					str += '<div class="left">';
					str+='<div style="height: 49.5%; display: flex; justify-content: center; align-items: center"><img class="machinesImg" src=\"'+preUrl+ machineNewUrl +'\" /></div>';
					str+='<div style="height: 49.5%; display: flex; justify-content: center; align-items: center; border-top: 1px solid #808080;"><img class="machinesImg" src=\"' + certificateFilePath + '\" /></div>';
					str += '</div>';
				}
				...
				str+='<tr class="ltr"><td class="ltd">出厂时间</td><td class="ldata"><input id="outFactortTime" value="'+JY.Object.notEmpty(l.outFactortTime)+'" type="text" /></td></tr>';
				...
				str+='<tr class="ltr"><td class="ltd">出厂编号</td><td class="ldata"><input id="outFactortNum" value="'+JY.Object.notEmpty(l.outFactortNum)+'" type="text" /></td></tr>';
				str+='<tr class="ltr"><td class="ltd">设备编码</td><td class="ldata"><input id="deviceCode" value="'+JY.Object.notEmpty(l.deviceCode)+'" type="text" /></td></tr>';
				str+='<tr class="ltr"><td class="ltd">固资编号</td><td class="ldata"><input id="assetNum" value="'+JY.Object.notEmpty(l.assetNum)+'" type="text" /></td></tr>';
				str+='<tr class="ltr"><td class="ltd">购置价格</td><td class="ldata"><input id="buyPrice" value="'+JY.Object.notEmpty(l.buyPrice)+'" type="text" /></td></tr>';
				...
				str+='<tr class="ltr"><td class="ltd">本次检修时间</td><td class="ldata"><input id="thisCheckTime" name="thisCheckTime" readonly value="'+JY.Object.notEmpty(l.thisCheckTime)+'" type="text" /></td></tr>';
				str+='<tr class="ltr"><td class="ltd">下次检修时间</td><td class="ldata"><input id="nextCheckTime" name="nextCheckTime" readonly value="'+JY.Object.notEmpty(l.nextCheckTime)+'" type="text" /></td></tr>';
				...
				'<tr class="ltr"><td class="ltd">备注</td><td class="ldata"><input id="remarks" value="'+JY.Object.notEmpty(l.remarks)+'" type="text" /></td></tr>';
				str+='<tr class="ltr"><td class="ldata"><button style="cursor: pointer;" onclick="updSubmit(&apos;'+ machinesId +'&apos;)">提交</button></td></tr>';
				'</table> </div>'
				$("#main").append(str);
				...
				layui.use(['laydate','upload'], function(){
					...
					var $ = layui.jquery;
					 ...
					 var uploadInst = upload.render({
				            elem: '#upload'
				            ,url: bonuspath + "/backstage/machine/uploadNewImg"
				            ,accept:'images'
				        	,exts: 'jpg|png|jpeg'
				            ,size:50000
				            ,data: {
				            ...
				            ,choose: function(obj){
				            	obj.preview(function(index, file, result){
				                    $('#machinePic').html('<img class="" src=\"' + result + '\" />');
