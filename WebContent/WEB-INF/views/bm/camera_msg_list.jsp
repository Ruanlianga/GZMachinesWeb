					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">摄像头名称</th>
								<th style="width:10%" class="center">序列号</th>
								<th style="width:10%" class="center">项目名称</th>
								<th style="width:10%" class="center">是否配置</th>
...
<script src="${bonuspath}/static/js/bm/cameraMsg.js?v=1"></script>		
</body>
</html>