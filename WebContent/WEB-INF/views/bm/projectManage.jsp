			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							&emsp;&nbsp;<input type="text" name="keyWord" placeholder="输入工程名称、人员关键字"   class="input-large">		
							<input type="text" name="startTime" id="startTime" readonly placeholder="开始时间"  class="times">
							<input type="text" name="endTime" id="endTime" readonly placeholder="结束时间"    class="times">		
							<font></font><select id="companyId" name="companyId"></select>
							<font></font><select id="typeId" name="typeId">
							</select>
							<font>结算：</font>
							<select id="isBal" name="isBal">
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
									...
									<th style="width:35%" class="center">工程名称</th>
									<th style="width:10%" class="center">所属分公司</th>
									<th style="width:8%" class="center">工程类型</th>
									<th style="width:8%" class="center">时间</th>
									<th style="width:5%" class="center">公里数</th>
									<th style="width:6%" class="center hidden-480">项目经理</th>
									<th style="width:8%"  class="center ">联系电话</th>
									<th style="width:8%"  class="center ">手机</th>
									<th style="width:13%" class="center hidden-480">操作</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
