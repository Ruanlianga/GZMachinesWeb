...
<script type="text/javascript">
	var maTypeId = localStorage.getItem("readAccId");
	var taskId = localStorage.getItem("taskId");
	var bonuspath = localStorage.getItem("bonuspath");
	findInvoiceUrl(maTypeId,taskId);
	function findInvoiceUrl(maTypeId,taskId){
		$.ajax({
			type: "post",
			...
			success: function(data) {
				var l = data.obj;
				var acceptUrl = l.checkUrl;
				$("#main").html("");
				var str = '';
				str+='<td style="height: 12px; padding-top: 0px; width: 500px">'+
				'<span style="font-size: 12px"><b>  </b></span> </td>'+
				'<td style="height: 12px; padding-top: 0px; width: 500px">'+
				'<img style="border: 0; margin-top: 0px;" src=\"'+bonuspath+'/acceptImg/'+ acceptUrl +'\" id="file2img" width="500" height="350" /></td>';
				$("#main").append(str);
			}
		});
	}
	...
	<table>
		<tr id="main" style="text-align: center;">
