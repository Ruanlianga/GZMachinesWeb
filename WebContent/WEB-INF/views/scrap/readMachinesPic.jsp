...
<script type="text/javascript">
	...
	findInvoiceUrl(picUrl);
	function findInvoiceUrl(picUrl){
		$.ajax({
			type: "post",
			url: bonuspath + "/backstage/scrapRecord/find",
			data: {
				picUrl: picUrl
			},
			dataType: "json",
			success: function(data) {
				...
				'<img style="border: 0; margin-top: 0px;" src=\"'+bonuspath+'/scrapImg/'+ machinesUrl +'\" id="file2img" width="650" height="350" /></td>';
				$("#main").append(str);
			}
		});
	}
