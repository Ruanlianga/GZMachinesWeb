...
<div class="page-content">
					...
					<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="row">
							<div class="widget-main">
							 &nbsp;&nbsp;机具名称:<select  style="width:15%"  id="typetId" name="typetId" onchange="loadNameById()">
                            </select>
                              &nbsp;&nbsp;规格型号: <select style="width:15%" id="typeParentId" name="typeParentId">
                            <option value="">--请先选名称--</option>
								...
								<button id='searchBtn' class="btn btn-warning btn-sm" title="过滤" type="button" onclick="getbaseList()">
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:8%" class="center">单号</th>
								<th style="width:6%" class="center">设备名称</th>
								...
								<th style="width:6%" class="center">审核人</th>
							    <th style="width:8%" class="center">审核时间</th>
							    <th style="width:15%" class="center">报废附件</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
	...
	<script src="${bonuspath}/static/js/scrap/scrapExamine.js?v=1"></script>	
</html>