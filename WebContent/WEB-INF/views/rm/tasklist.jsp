...
<div class="page-content">
		<div class="row-fluid">	
					...
					<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="row">
							<div class="widget-main">	
								...
								<button id='addBtn' class="btn btn-success btn-sm" title="新增" type="button" onclick="add()">新增</button>
								<button class="btn btn-fail btn-sm" title="删除申请" type="button" onclick="deleteTask()">删除</button>
							</div>				
						</div>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">领用方</th>
								<th style="width:8%" class="center">协议号</th>
								<th style="width:8%" class="center">退料单号</th>
								<th style="width:6%" class="center">退料人</th>
								<th style="width:8%" class="center">联系方式</th>
								<th style="width:6%" class="center">检验员</th>
								<th style="width:6%" class="center">退料状态</th>
								<th style="width:18%" class="center">备注</th>
			...
			<%@include file="checkertaskform.jsp" %> 
	...
	<script src="${bonuspath}/static/js/rm/task.js?v=1"></script>	
</html>