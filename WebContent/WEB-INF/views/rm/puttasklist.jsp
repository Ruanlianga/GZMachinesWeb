			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							...
							<select name="isSure" id="type">
								<option value="0">--完成情况选择--</option>
								<option value="0">未完成</option>
								<option value="1">已完成</option>
							</select>				
							<select name="putPerson" id="putPerson">
								<option value="">--选择指派客服代表--</option>
							...
							<button class="btn btn-fail btn-sm" title="删除申请" type="button" onclick="batchConfirmation()">批量指派</button>
						</div>				
					</div>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">入库类型</th>
								<th style="width:5%" class="center">入库数量</th>
...
<script src="${bonuspath}/static/js/rm/puttasklist.js?v=1"></script>		
</body>
</html>