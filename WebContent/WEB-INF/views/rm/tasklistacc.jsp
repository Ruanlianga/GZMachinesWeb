...
<%
	...
	String preDate = DateTimeHelper.getPreMonthDate();
%>
<style type="text/css">
	.filter-option{
		color:grey;
...
<div class="page-content">
					...
					<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="row">
							<div class="widget-main">	
								&emsp;&nbsp;<font>退料日期：</font> 
								<input class="datainp" id="startTime" name="startTime" value="<%=preDate %>" readonly placeholder="只显示年月" type="text"/>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<!-- <th style="width:10%" class="center">审核情况</th> -->
								<th style="width:10%" class="center">批准情况</th>
	...
	<script src="${bonuspath}/static/js/rm/taskAcc.js?v=1"></script>	
</html>