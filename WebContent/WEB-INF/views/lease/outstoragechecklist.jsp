			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							&emsp;<input type="text" readonly="readonly" value="<%=startTime%>" class="input-large" id="startTime" name="startTime" >
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">预检数量</th>
								<th style="width:10%" class="center">已检数量</th>
								<th style="width:8%" class="center">检验人</th>
								<th style="width:10%" class="center">检验时间</th>
...
<script src="${bonuspath}/static/js/lease/outstoragecheck.js?v=1"></script>		
</body>
</html>