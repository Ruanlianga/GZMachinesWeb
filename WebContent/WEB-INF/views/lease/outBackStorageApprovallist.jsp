			...
			<div class="col-xs-12">
					...
					<div class="row">
						...
						<font>&emsp;&nbsp;申请日期：</font> 
							...
							<button id='checkBtn' class="btn btn-warning btn-sm" title="批量退回" type="button" onclick="batchBack()">批量退回
							</button>
						</div>				
					</div>
...
<script src="${bonuspath}/static/js/lease/outBackStorageApproval.js?v=1"></script>		
</body>
</html>