...
<script src="${bonuspath}/static/js/sms.js"></script>
</head>
					...
					<div class="row">
						...
						<font>&emsp;&nbsp;申请日期：</font> 
							<div class="layui-input-inline">
						        <input type="text" value="<%=startTime%>" class="input-large" id="startTime" name="startTime" readonly/>
						        <input type="text" value="<%=endTime%>" class="input-large" id="endTime" name="endTime" readonly />
						    </div>
							<input type="text" name="keyWord" placeholder="这里输入关键词"   class="input-large">			
								是否批准：<select name="isApproval" id="isApproval">
							...
							<button id='checkBtn' class="btn btn-warning btn-sm" title="批量审核" type="button" onclick="batchAudit()">批量批准</button>
						</div>				
					</div>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">领料单号</th>
								<th style="width:10%" class="center">领料时间</th>
								<th style="width:10%" class="center">租赁单位</th>
								<th style="width:15%" class="center">工程名称</th>
								<th style="width:10%" class="center">机具名称</th>
								<th style="width:10%" class="center">机具规格</th>
								<th style="width:5%" class="center">出库数量</th>
								<th style="width:5%" class="center">出库人</th>
								<th style="width:5%" class="center">是否批准</th>
...
<script src="${bonuspath}/static/js/lease/outStorageApproval.js?v=1"></script>		
</body>
</html>