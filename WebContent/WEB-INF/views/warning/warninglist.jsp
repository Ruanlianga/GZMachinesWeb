...
<body>
			...
			<table id="bmTable"	class="table table-striped table-bordered table-hover" style="margin-top: 20px;">
				<thead>
					<tr>
						...
						<th style="width: 8%" class="center hidden-480">类型名称</th>
						<th style="width: 8%" class="center hidden-480">设备编号</th>
						<th style="width: 8%" class="center hidden-480">告警名称</th>
						<th style="width: 8%" class="center hidden-480">设备纬度</th>
						<th style="width: 8%" class="center hidden-480">设备经度</th>
	...
	<div>
			<%@include file="../warning/warningTipfrom.jsp"%>
		</div>
