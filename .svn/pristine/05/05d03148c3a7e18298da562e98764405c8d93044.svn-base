...
<body>
	<div class="page-content">
		<div>
			<%@include file="../warning/warningfrom.jsp"%>
		</div>
		<div class="row-fluid">
			...
			<table id="bmTable"	class="table table-striped table-bordered table-hover" style="margin-top: 20px;">
				<thead>
					<tr onclick='test()'>
						...
						<th style="width: 8%" class="center hidden-480">设备类型</th>
						<th style="width: 8%" class="center hidden-480">设备周期(天)</th>
	...
	<script src="${bonuspath}/static/js/warning/warning.js"></script>
</body>
</html>