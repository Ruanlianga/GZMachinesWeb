	...
	function findMachinesInfo(){
		$.ajax({
			...
			success: function(data) {
				...
				'<tr class="ltr"><td class="ltd">类型名称</td><td class="ldata">'+ JY.Object.notEmpty(l.type0) +'</td></tr>'+
				...
				'<tr class="ltr"><td class="ltd">机具型号</td><td class="ldata">'+ JY.Object.notEmpty(l.type0) +'</td></tr>'+
				'<tr class="ltr"><td class="ltd">出厂时间</td><td class="ldata">'+ JY.Object.notEmpty(l.outFactortTime) +'</td></tr>';
				if(l.outFactortNum == null || l.outFactortNum == 'null'){
					str+='<tr class="ltr"><td class="ltd">出厂编号</td><td class="ldata"><input id="outFactortNum" type="text" /><span onclick="writeNum(&apos;'+ machinesId +'&apos;)">提交</span></td></tr>';
				}else{
				...
				if(l.equipmentState == "1" || l.equipmentState == 1){
					str += '<tr class="ltr"><td class="ltd">设备状态</td><td class="ldata">完好</td></tr>';
				}else if(l.equipmentState == "0" || l.equipmentState == 0){
					str += '<tr class="ltr"><td class="ltd">设备状态</td><td class="ldata">损坏</td></tr>';
				}
				str+='</table><div class="line"></div>';
				str+='<table class="rdetails">';
				
				if(l.assetNum == null || l.assetNum =='null'){
					str+='<tr class="ltr"><td class="ltd">资产编号</td><td class="ldata">暂无</td></tr>';
				}else{
					str+='<tr class="ltr"><td class="ltd">资产编号</td><td class="ldata">'+ JY.Object.notEmpty(l.assetNum) +'</td></tr>';
				}
				str+='<tr class="ltr"><td class="ltd">本次检修人员</td><td class="ldata">'+ JY.Object.notEmpty(l.thisServiceman) +'</td></tr>'+
				...
				'<tr class="ltr"><td class="ltd">出入库次数</td><td class="ldata">'+ JY.Object.notEmpty(l.outInNum) +'</td></tr>'+
