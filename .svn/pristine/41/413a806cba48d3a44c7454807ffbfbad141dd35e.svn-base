					...
					<div class="row">
						<div class="widget-main">	
							<div class="layui-input-inline">
					       		&emsp;&nbsp;入库时间：<input type="text" value="<%=preMonthTime%>" readonly class="input-large" id="startTime" name="startTime" >
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">采购价格</th>
								<th style="width:10%" class="center">机具厂家</th>
								<th style="width:8%" class="center">采购时间</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
...
<script src="${bonuspath}/static/js/newInput/newReport.js?v=1"></script>	
</body>
</html>