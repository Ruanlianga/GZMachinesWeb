...
<div class="page-content">
		<div class="row-fluid">	
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">区域长度(米)</th>
								<th style="width:10%" class="center">区域宽度(米)</th>
								<th style="width:10%" class="center">区域面积</th>
								<th style="width:10%" class="center">x轴</th>
								<th style="width:10%" class="center">y轴</th>
								<th style="width:10%" class="center">区域类型</th>
			...
			<!-- #addorUpdateFrom -->
			<%@include file="houseAreaform.jsp" %>
			<!-- #dialog-confirm -->
			<%@include file="../dialog.jsp" %>	
			</div>
		</div>
	</div>
<script src="${bonuspath}/static/js/bm/houseArea.js?v=1"></script>		
</body>
</html>