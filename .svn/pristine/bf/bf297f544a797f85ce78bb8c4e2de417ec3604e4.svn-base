						...
						<div class="row">
							<div class="widget-main">	
						       ...
						       &nbsp;<input type="text" name="maModel" id="maModel" placeholder="这里输入机具规格"   class="input-large">	 
								<select name="rmStatus" id="rmStatus">
								<option value="0">--退料状态选择--</option>
								<option value="1">合格入库</option>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							...
							<!-- 	<th style="width:10%" class="center">协议号</th> -->
								...
								<th style="width:8%" class="center">设备编码</th>
								<th style="width:8%" class="center">备注</th>
								<th style="width:8%" class="center">退料数量</th>
								<th style="width:8%" class="center">退料时间</th>
								<th style="width:8%" class="center">退料状态</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
