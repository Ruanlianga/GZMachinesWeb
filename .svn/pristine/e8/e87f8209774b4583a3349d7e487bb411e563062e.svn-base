   ...
   <label class="layui-form-label ">选择文件:</label>
	<div class="layui-upload">
        ...
        <div class="layui-upload-list">
            <img class="layui-upload-img" id="demo1" width= "92%" height= "269px">
            <p id="demoText"></p>
        </div>
    </div>
		...
		layui.use('upload', function(){
		    ...
		    var $ = layui.jquery
		        ...
		        var uploadInst = upload.render({
		            elem: '#test1'
		            ,url: bonuspath + "/backstage/agreement/uploadAgreePic"
		            ,accept:'images'
		            ,size:50000
		            ...
		            ,done: function(res){
		            	var fileName = res.data.agreePicName;
		            	var filePath = res.data.urlPath;
		            	localStorage.setItem("agreePicName",fileName);
		            	localStorage.setItem("urlPath",filePath);
		                //如果上传失败
		                if(res.code > 0){
