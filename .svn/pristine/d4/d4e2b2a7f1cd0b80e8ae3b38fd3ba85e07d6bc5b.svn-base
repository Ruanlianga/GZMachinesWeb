...
<div class="page-content" >
		<div class="row-fluid">	
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead >
							<tr>
								...
								<th style="width:5%" class="center">批次编号</th>
								<th style="width:5%" class="center">批次时间</th>
								<th style="width:5%" class="center">机具名称</th>
								<th style="width:5%" class="center">规格型号</th>
								<!-- <th style="width:5%" class="center">机具数量</th> -->
								<th style="width:5%" class="center">机具单位</th>
								<th style="width:5%" class="center">机具重量（kg）</th>
								<th style="width:5%" class="center">机具图片</th>
								<!--<th style="width:5%" class="center">批次状态</th>-->
			...
			<!-- #addorUpdateFrom -->
			<%@include file="repairDetailsform.jsp" %>
			<!-- #dialog-confirm -->
			<%@include file="../dialog.jsp" %>	
			</div>
		</div>
	</div>
<script src="${bonuspath}/static/js/lease/repairDetalis.js?v=1"></script>		
</body>
</html>