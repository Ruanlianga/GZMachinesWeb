			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" name="name" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
					<td class="CaptionTD">资源图标：</td>
						<td class="DataTD">&nbsp;
						<span class="input-icon">
							<input type="text" readonly name="icon"  class="FormElement ui-widget-content ui-corner-all isSelect147" >
							<i id="selecticonId" ></i>
						</span>
					...
					<tr class="FormData" id="trresUrl">
						...
						<td class="DataTD">&nbsp;
						<input type="text" name="url" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData hide" id="trbtnId">
						<td class="CaptionTD">标签主键：</td>
						<td class="DataTD">&nbsp;
						<input type="text"   name="btnId" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
						<tr class="FormData hide" id="trbtnFun">
						<td class="CaptionTD">标签方法：</td>
						<td class="DataTD">&nbsp;
						<input type="text"   name="btnFun" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD">资源描述：</td>
						<td class="DataTD">&nbsp;
						<textarea rows="2" cols="10" name="description" multiline="true" class="FormElement ui-widget-content ui-corner-all isSelect147"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
