...
<div class="page-content">
		<div class="row-fluid">	
			<div class="col-xs-12">
					...
					<input type='hidden' class='backOutNum' name='outNum'/>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:15%" class="center">领料批次</th>
								<th style="width:15%" class="center">机具名称</th>
								<th style="width:10%" class="center">机具型号</th>
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="dataTables_info customBtn" >
								<a href="#" title="退料" id="backMachines" class="lrspace3" >
...
<script src="${bonuspath}/static/js/lease/back_machine_details.js?v=1"></script>		
</body>
</html>