			...
			<div class="col-xs-12">
				...
				<div class="widget-header widget-header-large">				
					<div class="widget-main customBtn">	
						<button title="选择显示层级" value='1' class="btn btn-sm btn-success"><i class="icon-desktop"></i></button>					
						<button title="选择显示层级" value='2' class="btn btn-sm"><i class="icon-th"></i></button>		
						<button title="选择显示层级" value='3' class="btn btn-sm"><i class="icon-user"></i></button>		
						<button title="选择显示层级" value='4' class="btn btn-sm"><i class="icon-bitbucket"></i></button>
