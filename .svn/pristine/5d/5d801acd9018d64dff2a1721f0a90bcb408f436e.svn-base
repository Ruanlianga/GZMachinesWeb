			...
			<form id="perfileSettingFrom" method="POST" onsubmit="return false;">
				<div class="profile-user-info profile-user-info-striped">
					...
					<div class="profile-info-row">
						...
						<div class="profile-info-value tab-pane-right">
							<div class="clearfix">
								<input type="text" jyValidate="email" id='perDataEmail' maxlength="120" name='mail' class="col-xs-12">
							</div>
						</div>
					</div>
					<div class="profile-info-row">
						...
						<div class="profile-info-value tab-pane-right">
							<div class="clearfix">
								<input type="text" jyValidate="phone" id='perDataPhone' maxlength="120" name='telphone' class="col-xs-12">
							</div>
						</div>
					</div>
				</div>
