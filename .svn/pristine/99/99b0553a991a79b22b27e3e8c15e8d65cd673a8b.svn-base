...
<div class="page-content">
					...
					<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="row">
							<div class="widget-main">	
								&emsp;&nbsp;<font>选择日期：</font> 
								<input class="datainp" id="startTime" name="startTime" value="<%=endTime %>" readonly placeholder="只显示年月" type="text"/>
								...
								<button id='searchBtn' class="btn btn-warning btn-sm" title="过滤" type="button" onclick="getbaseList(1)">
								 ...
								 <button type="button" class="btn btn-sm btn-danger" onclick="exportData();">导出数据</button>
								  <button type="button" class="btn btn-sm btn-danger" onclick="print();">打印</button>
								  <button type="button" class="btn btn-sm btn-danger" onclick="upload();">批量上传</button>
							</div>				
						</div>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
							    ...
							    <th style="width:6%" class="center">维修数量</th>
							    <th style="width:8%" class="center">设备编号</th>
							    <th style="width:8%" class="center">编号备注</th>
							    <th style="width:10%" class="center">维修人员</th>
							    <th style="width:10%" class="center">维修时间</th>
							    <th style="width:10%" class="center">维修附件</th>
							    <th style="width:10%" class="center">照片查看</th>
							    <th style="width:10%" class="center">维修结果</th>
	...
	<script src="${bonuspath}/static/js/repair/repairTaskRecordList.js?v=1"></script>	
</html>