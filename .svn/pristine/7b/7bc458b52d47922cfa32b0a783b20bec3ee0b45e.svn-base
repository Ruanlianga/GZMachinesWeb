			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							<font>领料日期：</font> 
							<input class="datainp" id="backTime" name="backTime" readonly value="<%=currentDate%>" placeholder="只显示年月" type="text" style="height: 30px; margin: 0px"/>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:12%" class="center">批次</th>
								<th style="width:15%" class="center">领料时间</th>
								<th style="width:15%" class="center">退料时间</th>
								<th style="width:14%" class="center">退料单位</th>
								<th style="width:20%" class="center">退料工程</th>
...
<script src="${bonuspath}/static/js/lease/repair_machine.js?v=1"></script>		
</body>
</html>