...
<script type="text/javascript">
	...
	findInvoiceUrl(taskId,maModelId);
	function findInvoiceUrl(taskId,maModelId){
		$.ajax({
			type: "post",
			...
			success: function(data) {
				var l = data.obj;
				var invoiceUrl = l.invoiceUrl;
				$("#main").html("");
				var str = '';
				str+='<td styleukz="height: 12px; padding-top: 0px; width: 100px">'+
				'<span style="font-size: 12px"><b>  </b></span> </td>'+
				'<td style="height: 12px; padding-top: 0px; width: 300px">'+
				'<img style="border: 0; margin-top: 0px;" src=\"'+bonuspath+'/invoiceImg/'+ invoiceUrl +'\" id="file2img" width="650" height="350" /></td>';
				$("#main").append(str);
			}
		});
	}
