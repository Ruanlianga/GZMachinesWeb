					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:12%" class="center">仓库名称</th>
								<th style="width:12%" class="center">资产编号</th>
								<th style="width:12%" class="center">资产类别</th>
								<th style="width:10%" class="center">设备名称</th>
								<th style="width:10%" class="center">规格型号</th>
								<th style="width:10%" class="center">单位</th>
								<th style="width:10%" class="center">租赁日期</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
...
function getbaseList(init){
	...
	$.ajax({        
        type:"POST",  
        url:bonuspath +'/backstage/app/out/findQueryContent', 
