...
<div class="page-content">
		<div class="row-fluid">	
			<div class="col-xs-12">
			   ...
			   <!--                    <th style="width:10%" class="center">型号</th> -->
		                           <th style="width:10%" class="center">备注</th>
								<th style="width:10%" class="center">是否是消耗品</th>
...
<!-- 								<a href="#" title="批量删除" id="delBatchBtn" class="lrspace3" ><i class='icon-trash color-red bigger-220'></i></a>
 -->							</div>
			...
			<!-- #addorUpdateFrom -->
			<%@include file="partsTypeform.jsp" %>
			<!-- #dialog-confirm -->
			<%@include file="../dialog.jsp" %>	
			</div>
		</div>
	</div>
<script src="${bonuspath}/static/js/part/partsType.js?v=1"></script>		
</body>
</html>