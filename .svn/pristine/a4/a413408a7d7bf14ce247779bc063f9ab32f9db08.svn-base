			...
			<div class="col-xs-12" style="width: 55%;">
					...
					<div class="row">
						<div class="col-sm-9" style="width: 83%">
							<!--设置分页位置-->
							<div id="pageing" class="dataTables_paginate paging_bootstrap" style="width: 100%">
				...
				<!-- #dialog-confirm -->
				<%@include file="./matchDeviceCodeform.jsp" %>	
...
<script src="${bonuspath}/static/js/ma/synthesis.js?v=1"></script>		
</body>
</html>