...
<div class="page-content">
					...
					<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="row">
							<div class="widget-main">	
								...
								<select name="isApproval" id="isApproval">
								<option value="0">--批准情况选择--</option>
								...
								<button id='checkBtn' class="btn btn-warning btn-sm" title="批量批准" type="button" onclick="batchAudit()">批量批准
								</button>
							</div>				
						</div>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:8%" class="center">是否批准</th>
	...
	<script src="${bonuspath}/static/js/rm/returnApproval.js?v=1"></script>	
</html>