...
public class ScrapDetailsBean {
	...
	public String getScrapPersonIds() {
		return scrapPersonIds;
	}

	public void setScrapPersonIds(String scrapPersonIds) {
		this.scrapPersonIds = scrapPersonIds;
	}
