...
<div class="page-content">
		<div class="row-fluid">	
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:15%" class="center">分公司名称</th>
								<th style="width:15%" class="center">分公司编号</th>
			...
			<!-- #addorUpdateFrom -->
			<%@include file="./branch_company_form.jsp" %>
			<!-- #dialog-confirm -->
			<%@include file="../dialog.jsp" %>	
			</div>
		</div>
	</div>
<script src="${bonuspath}/static/js/bm/branch_company.js?v=1"></script>		
</body>
</html>