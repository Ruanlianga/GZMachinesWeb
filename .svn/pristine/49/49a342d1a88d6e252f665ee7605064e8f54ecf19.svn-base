    ...
    <div class="tab-content noline tabCenter">
		...
		<div id="proSetting" class="tab-pane">
			  <table  class="customTable">
			  	...
			  	<tr class="FormData">
					<td>
					<input id="jy-settings-add-container" name="narWinMenu" class="ace ace-checkbox-2" type="checkbox"> 
					<label class="lbl" for="jy-settings-add-container"> 切换窄屏幕 <b></b></label>
					</td>
			  	</tr>
			  	<tr class="FormData">
					<td>
					<input id="jy-settings-sfMenu" name="sfMenu" class="ace ace-checkbox-2" type="checkbox"> 
					<label class="lbl" for="jy-settings-sfMenu"> 缩放菜单栏 <b></b></label>
					</td>
			  	</tr>			  	
			  	<tr class="FormData">
					<td>
				  		<input id="jy-settings-rtl" name="posMenu" class="ace ace-checkbox-2" type="checkbox">
...
<div id="perData" class="hide">
	<div class="tabbable">
		<ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
			<li class="active"><a href="#perfileSetting" data-toggle="tab">个人资料</a></li>
			<li class=""><a href="#pwSetting" data-toggle="tab">密码管理</a></li>
		</ul>
		<div class="tab-content noline">
			<div class="tab-pane active" id="perfileSetting">
			<form id="perfileSettingFrom" method="POST" onsubmit="return false;">
				<div class="profile-user-info profile-user-info-striped">
					...
					<div class="profile-info-row">
						...
						<div class="profile-info-value tab-pane-right">
							<div class="clearfix">
								<input type="text" id='perDataName'  name='name' class="col-xs-12">
							</div>
						</div>
					</div>
					<div class="profile-info-row">
						...
						<div class="profile-info-value tab-pane-right">
							<div class="clearfix">
								<input type="text" jyValidate="email" id='perDataEmail' name='mail' class="col-xs-12">
							</div>
						</div>
					</div>
					<div class="profile-info-row">
						<div class="profile-info-name tab-pane-left">电话号码</div>
						<div class="profile-info-value tab-pane-right">
							<div class="clearfix">
								<input type="text" jyValidate="phone" id='perDataPhone' name='telphone' class="col-xs-12">
							</div>
						</div>
					</div>
				</div>
			...
			<form id="pwSettingFrom" method="POST" onsubmit="return false;">
				<table class="customTable">
					<tr class="FormData">
						...
						<td class="DataTD">
							<span class="input-icon"> <input name="opwd" type="password" > <i class="icon-lock blue"></i></span>
						</td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD">
						...
						<td class="DataTD">
							<span class="input-icon"> <input name="npwd" type="password" placeholder="" value=""> <i class="icon-lock green"></i></span>
						</td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD">
						...
						<td class="DataTD">
							<span class="input-icon"> <input name="qpwd" type="password" placeholder="" value=""> <i class="icon-lock green"></i></span>
						</td>
					</tr>
				</table>
			</form>
